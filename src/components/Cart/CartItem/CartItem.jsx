      ...
      <div className='flex flex-col'>
        ...
        <div className='grid grid-rows-1 grid-cols-3 justify-end items-center place-content-end mt-6 px-8'>
          <button
            ...
            className='text-red-500 hover:text-white hover:bg-red-500 hover:rounded-full flex items-center justify-center w-8 h-8'
          >
          ...
          <div className='flex items-center justify-center '>
            <button
              ...
              className='flex items-center justify-center w-8 h-8 border-2 border-slate-500 rounded-tl-md rounded-bl-md hover:border-slate-800 text-slate-700  hover:text-slate-900 '
            >
            ...
            <button
              onClick={() => onUpdateCartQty(item.id, item.quantity + 1)}
              className='flex items-center justify-center w-8 h-8 border-2 border-slate-500 text-slate-700 rounded-tr-md rounded-br-md hover:border-slate-800 hover:text-slate-900 '
            >
              <p className='w-6 h-6'>+</p>
            </button>
          </div>
